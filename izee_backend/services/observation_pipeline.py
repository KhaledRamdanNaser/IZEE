...
def process_observation_pipeline(
    ...
    try:
        ...
        if db_state:
            ...
            db_state.assignment_id = db_observation.assignment_id
            db_state.driver_id = db_observation.driver_id
            db_state.trip_id = db_observation.trip_id
            ...
            db_state = VehicleLiveState(
                ...
                assignment_id=db_observation.assignment_id,
                driver_id=db_observation.driver_id,
                trip_id=db_observation.trip_id
            )
            db.add(db_state)
